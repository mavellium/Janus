...
export default async function LandingPagesPage({
  ...
  const canCreate = hasPermission(sessionWithFreshPerms, 'PROJECT_CREATE', 'landingPages', 'project', impersonating)
  const canEdit = hasPermission(sessionWithFreshPerms, 'PROJECT_EDIT', 'landingPages', 'project', impersonating)
  const canDelete = hasPermission(sessionWithFreshPerms, 'PROJECT_DELETE', 'landingPages', 'project', impersonating)
  const canManageBlog = hasPermission(sessionWithFreshPerms, 'BLOG_MANAGE', 'landingPages', 'project', impersonating)
