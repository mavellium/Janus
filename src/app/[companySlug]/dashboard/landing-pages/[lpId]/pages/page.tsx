...
export default async function LandingPagePagesPage({
  ...
  const canCreate = hasPermission(sessionWithFreshPerms, 'PAGE_CREATE', 'landingPages', 'page', viewMode)
  const canBuild = hasPermission(sessionWithFreshPerms, 'PAGE_BUILD', 'landingPages', 'page', viewMode)
  const canDelete = hasPermission(sessionWithFreshPerms, 'PAGE_DELETE', 'landingPages', 'page', viewMode)
