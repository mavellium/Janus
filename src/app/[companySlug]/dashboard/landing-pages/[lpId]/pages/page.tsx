...
export default async function LandingPagePagesPage({
  ...
  const canCreate = hasPermission(sessionWithFreshPerms, 'PAGE_CREATE', 'landingPages', 'page')
  const canBuild = hasPermission(sessionWithFreshPerms, 'PAGE_BUILD', 'landingPages', 'page')
  const canDelete = hasPermission(sessionWithFreshPerms, 'PAGE_DELETE', 'landingPages', 'page')
