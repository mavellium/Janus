...
export default async function LandingPagePagesPage({
  ...
  const canCreate = hasPermission(sessionWithFreshPerms, 'PAGE_CREATE', 'landingPages', 'page', impersonating)
  const canBuild = hasPermission(sessionWithFreshPerms, 'PAGE_BUILD', 'landingPages', 'page', impersonating)
  const canDelete = hasPermission(sessionWithFreshPerms, 'PAGE_DELETE', 'landingPages', 'page', impersonating)
  ...
  return (
    <div className="p-8 w-full">
      <div className="mb-8 flex items-center justify-between">
        ...
        {canCreate && <CreatePageModal projectId={lpId} companySlug={companySlug} />}
      </div>
