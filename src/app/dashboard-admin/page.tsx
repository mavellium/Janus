...
export default async function AdminDashboardPage() {
  ...
  const METRICS = [
    { label: 'Usuários', value: stats.usersCount, icon: Users, href: '/dashboard-admin/users' },
    { label: 'Desenvolvedores', value: stats.developersCount, icon: Code2, href: '/dashboard-admin/developers' },
    { label: 'Empresas', value: stats.companiesCount, icon: Building2, href: '/dashboard-admin/companies' },
    { label: 'IPs Bloqueados', value: stats.blockedCount, icon: Shield, href: '/dashboard-admin/logs' },
  ]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card border border-border rounded-xl overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            ...
            <Link href="/dashboard-admin/companies" className="text-xs text-brand-primary hover:underline">
              Ver todas
            </Link>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            ...
            <Link href="/dashboard-admin/users" className="text-xs text-brand-primary hover:underline">
              Ver todos
            </Link>
          </div>
