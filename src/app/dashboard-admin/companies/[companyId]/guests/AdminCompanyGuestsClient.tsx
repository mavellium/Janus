...
import { ArrowLeft, UsersRound, Pencil, Trash2, Images, Code2, Copy } from 'lucide-react'
...
export function AdminCompanyGuestsClient({ company, guests }: { company: Company; guests: Guest[] }) {
  const searchParams = useSearchParams()
    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-brand-text">Convidados de {company.name}</h1>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        {guests.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            ...
            <p className="text-sm text-brand-muted">Nenhum convidado nesta empresa</p>
          </div>
        ) : (
