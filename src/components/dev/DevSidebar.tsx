...
export function DevSidebar({ email, image, devId }: DevSidebarProps) {
  ...
  const isActive = (href: string) => {
    ...
    if (href === `/dev/${devId}/dashboard`) return false
        ...
        >
          ...
          {!collapsed && (
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ fontSize: '11px', opacity: 0.6, margin: 0 }}>Desenvolvedor</p>
            </div>
          )}
        </div>
